...
> **Status: v0.1.1.** Login, role-aware nav, jobs/queues/recurring/servers, users, audit, polled ops charts. Production image on GHCR (tag `v0.1.1`, amd64+arm64). Pair with gfireui-backend.
